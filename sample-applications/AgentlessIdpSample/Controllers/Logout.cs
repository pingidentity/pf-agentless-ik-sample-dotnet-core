    ...
    public class LogoutController : Controller
    {
        ...
        public IActionResult Index()
        {
            if (Request.Method == "POST")
            {
                ...
                ViewData["resumeUrl"] = UrlUtils.resumeLogoutUrl(_configuration.GetValue<string>(IdpConstants.ADAPTER_CONFIG_SECTION + ":" + IdpConstants.BASE_PF_URL),
                                                                    Request.Form[IdpConstants.RESUME_PATH], referenceId);
